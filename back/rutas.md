...
- **Respuesta:**
  ...
  - 404: Si el usuario no fue encontrado. |DUDOSO, PROFE CAMILO LO HACE CON ERROR 400, PERO IGUAL LO HICE CON ERRO 404|
...
### POST /appointments/schedule |HECHO|
...
### PUT /appointments/cancel/:id |HECHO|
